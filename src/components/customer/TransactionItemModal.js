...
function TransactionItemModal({setTransactionModel, transaction, orderNumber}) {
  return (
    <div>
      <div
      ...
      <div className="fixed left-0 top-0 right-0 mt-10 bg-white w-11/12 border z-20 border-gray-300 rounded-md mx-auto p-5 overflow-y-scroll">
        ...
        <div className="grid grid-cols-12 gap-4 w-full justify-items-center items-center font-bold bg-black text-white py-2 mt-5">
